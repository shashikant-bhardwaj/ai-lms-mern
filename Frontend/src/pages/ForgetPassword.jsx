...
function ForgetPassword() {
  ...
  const resetPasswordHandler = async (e) => {
    ...
    if (newPassword != conPassword)
      return toast.success("password is not  matched");
  ...
  return (
    ...
    >
      ...
      {step == 1 && (
        <div
          className="flex flex-col bg-white shadow-md rounded-xl p-8 max-w-md
      w-full"
        >
          <h2
      ...
      w-full"
        ...
        text-white py-2 px-4 rounded-md font-medium cursor-pointer"
            >
              {loading2 ? <ClipLoader size={30} color="white" /> : "Verify OTP"}
            </button>
          </form>
          <div
            onClick={() => navigate("/login")}
